...
urlpatterns = [
    ...
    path('redit-article/<int:article_id>/',views.redit_article,name='redit_article'), re_path('article-detail/(?P<id>\d+)/(?P<slug>[-\w]+)/$', views.article_detail, name="article_detail"),
